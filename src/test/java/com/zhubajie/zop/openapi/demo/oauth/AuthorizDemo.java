...
public class AuthorizDemo {
	
	/** 授权请求域名*/
	private final static String BASE_PATH = "http://openapi.zbj.com";
	/** 编码格式*/
	...
	public static void main(String[] args) throws IOException {
		// 初始化授权基本参数
		OAuth2 oauth2 = new OAuth2("2016091921162624iN30",
				"ADE898CE6277A64B6A875C17A4CDE996",
				"http://openapi.zbj.com/oauth2/success");

		/*
		 * 根据所需设置相应参数
		 */
		oauth2.setScope("zbj.user.getUserBaseInfo-1.0 zbj.tradeOrder.queryOrderInfo-1.0");
