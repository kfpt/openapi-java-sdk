...
public class CategoryPubNodeInfo2{
	...
	private List<CategoryPubNodeInfo> children;

	public List<CategoryPubNodeInfo> getChildren() {
		return children;
	}

	public void setChildren(List<CategoryPubNodeInfo> children) {
