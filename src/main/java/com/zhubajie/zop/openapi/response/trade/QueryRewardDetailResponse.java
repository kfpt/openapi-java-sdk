...
@XmlRootElement(name = "queryRewardDetail")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlAccessorOrder
public class QueryRewardDetailResponse extends AbstractSuccessResponse {
	...
	@XmlElement
	private Integer mode; // 交易模式：10悬赏，购买服务，12雇佣，13招标
	@XmlElement
